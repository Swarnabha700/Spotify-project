...
//Function will take a folder name to find songs
...
//Display all the albums with json
...
async function main() {
    ...
    document.querySelector(".range").getElementsByTagName("input")[0].addEventListener("change", (e) => {
        ...
        else if (currentSong.volume > 0 & currentSong.volume < 0.2) {
            vol.src = "img/lowvolume.svg"
        }
        else if (currentSong.volume > 0.201 & currentSong.volume < 0.6) {
            vol.src = "img/mediumVolume.svg"
        }
        else {
    ...
    //Add an event listener to volume button for direct mute
